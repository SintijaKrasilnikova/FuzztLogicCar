...
public class FuzzyBox : MonoBehaviour {
    ...
    void Start()
	{
        ...
        var right = distance.MembershipFunctions.AddTrapezoid("right", -midValue, -midValue, -5, -1);
        var none = distance.MembershipFunctions.AddTrapezoid("none", -5, -0.5, 0.5, 5);
        var left = distance.MembershipFunctions.AddTrapezoid("left", 1, 5, midValue, midValue);
        ...
        var d_right = direction.MembershipFunctions.AddTrapezoid("right", -midValue, -midValue, -5, -1);
        var d_none = direction.MembershipFunctions.AddTrapezoid("none", -5, -0.5, 0.5, 5);
        var d_left = direction.MembershipFunctions.AddTrapezoid("left", 1, 5, midValue, midValue);
